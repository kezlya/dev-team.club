export default {
  ...
  hiringSubtitle:
    "В данный момент к нам в команду требуются следущие специалисты:",
